...
function Features() {
  ...
  return (
    <div
      className="feature-main-container container-fluid d-flex justify-content-center align-items-center gap-5 mt-2"
      ref={ref}
      style={{
    ...
    >
      ...
      >
        <div
          className="feature-div-left w-100 d-flex flex-column gap-3"
          data-aos="fade-left"
        >
