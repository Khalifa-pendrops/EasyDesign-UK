...
function Pricing() {
  ...
  return (
    ...
    >
      <section
        id="pricing"
        className="pricing-parent-container container-xxl my-5 d-flex flex-column justify-content-center align-items-center gap-5"
      >
        <div
        ...
        <div className="pricing-bottom-div d-flex flex-column flex-sm-row justify-content-center align-items-start gap-5">
          <div
